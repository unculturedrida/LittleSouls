...
<!-- Mirrored from wpthemebooster.com/demo/themeforest/html/kleon/two-step-varification.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:15:06 GMT -->
<head>
        <!-- Meta Tags -->
        <meta charset="utf-8">
            ...
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6">
                <div class="card rounded-2 border-0 p-5 m-0"> 
                    ...
                    <div class="card-header border-0 p-0 text-center">
                        ...
                        <h3>Two Step Varification</h3>
                        <p class="fs-14 text-dark my-4">We sent a varification code through your email address. Please enter the code from your email.</p>
                    </div>
                    
                    <div class="card-body p-0">
                        <form class="form-horizontal" method="post">
                            <div class="form-group">
                                <label class="form-label text-gray">Enter your 6 digits security code</label>
                            ...
                            <button type="submit" class="btn btn-primary w-100 text-uppercase text-white rounded-2 lh-34 ff-heading fw-bold shadow">Verify</button>
                            <p class="mt-4 mb-0 text-center"><a href="#" class="text-primary fw-bold text-decoration-underline">Didn't recieve the code?</a></p>
                        </form>
                    </div>
                </div>
            </div>
