...
<!-- Mirrored from wpthemebooster.com/demo/themeforest/html/kleon/form-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 14:14:57 GMT -->
<head>
        <!-- Meta Tags -->
        <meta charset="utf-8">
            ...
            <div class="container-fluid">
                <div class="inner-contents">
                    <div class="page-header d-flex align-items-center justify-content-between mr-bottom-30">
                        <div class="left-part">
                            <h2 class="text-dark">Basic Form</h2>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="first_name" value="" placeholder="Full Name">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-label">Email</label> <small class="text-muted">eg: admin@email.com</small>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="pasword" placeholder="Type Password" value="1234" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="form-label">Message</label>
                                            <textarea class="form-control" name="textarea" placeholder="Enter Text"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="card border-0">
                        <div class="card-header bg-transparent border-0 p-5 pb-0">
                            <h5 class="mb-0">Disabled & Readonly Fields</h5>
                        </div>

                        <div class="card-body pt-3">
                            <form class="" method="post">
                                <div class="form-group">
                                    <label class="form-label">Disable Input</label>
                                ...
                                <div class="form-group">
                                    <label class="form-label">Readonly Static</label>
                    ...
                    <div class="card border-0">
                        <div class="card-header bg-transparent border-0 p-5 pb-0">
                            <h5 class="mb-0">Range & Color Input</h5>
                        </div>
                        ...
                        <div class="card-body pt-3">
                            <form class="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="range" class="form-range" name="range" value="">
                                </div>

                                <div class="form-group">
                                    <label class="form-label mb-0">Color</label>
                                    <input type="color" class="bg-light-blue border-primary rounded-1 px-1 py-1" name="colorpicker" value="#fd7e14">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="fileUploadMultiple" multiple>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-label">Disabled File Input</label>
                                            <input type="file" class="form-control" name="fileUpload" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card border-0">
                                <div class="card-header bg-transparent border-0 p-5 pb-0">
                                    <h5 class="mb-0">Success Border with Icons</h5>
                                </div>
        
                                <div class="card-body pt-3">
                                    <form class="form-horizontal-icons" method="post">
                                        <div class="form-group">
                                            <label class="form-label">First Name</label>
                                            <div class="input-group">
                                                <span class="badge d-flex align-items-center  text-blue rounded-0 rounded-start py-2 px-3 border border-success fs-16"><i class="bi bi-person"></i></span>
                                                <input type="text" class="form-control border-success" name="full_name" value="" placeholder="Full Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="badge d-flex align-items-center  text-blue rounded-0 rounded-start py-2 px-3 border border-success fs-16"><i class="bi bi-person"></i></span>
                                                <input type="email" class="form-control border-success" name="email" value="" placeholder="admin@example.com" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="badge d-flex align-items-center  text-blue rounded-0 rounded-start py-2 px-3 border border-success fs-16"><i class="bi bi-person"></i></span>
                                                <input type="number" class="form-control border-success" name="phone" placeholder="Phone Number">
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card border-0">
                                <div class="card-header bg-transparent border-0 p-5 pb-0">
                                    <h5 class="mb-0">Danger Border with Icons</h5>
                                </div>
                                ...
                                <div class="card-body pt-3">
                                    <form class="form-horizontal-icons" method="post">
                                        <div class="form-group">
                                            <label class="form-label">First Name</label>
                                            <div class="input-group">
                                                <span class="badge d-flex align-items-center  text-blue rounded-0 rounded-start py-2 px-3 border border-danger fs-16"><i class="bi bi-person"></i></span>
                                                <input type="text" class="form-control border-danger" name="full_name" value="" placeholder="Full Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="badge d-flex align-items-center  text-blue rounded-0 rounded-start py-2 px-3 border border-danger fs-16"><i class="bi bi-person"></i></span>
                                                <input type="email" class="form-control border-danger" name="email" value="" placeholder="admin@example.com" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="badge d-flex align-items-center  text-blue rounded-0 rounded-start py-2 px-3 border border-danger fs-16"><i class="bi bi-person"></i></span>
                                                <input type="number" class="form-control border-danger" name="phone" placeholder="Phone Number">
                                            </div>
                                        </div>
