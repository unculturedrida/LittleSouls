                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="card-footer d-flex align-items-center justify-content-between gap-4 flex-wrap p-0 pt-5 mt-6">
                                                ...
                                                <div class="btn-group flex-shrink-0">
                                                    <a href="inbox.php" class="btn bg-soft-success btn-outline-success rounded-2 ff-heading fs-18 fw-bold lh-24 py-3"> Learn More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            ...
                                                            <div>
                                                                <a href="invoice.php" class="fs-14 fw-semibold">#INV-0001234</a>
                                                    ...
                                                    <td>
                                                        <div class="dropdown text-end">
                                                            ...
                                                            <div class="dropdown-menu p-0">
                                                                <a class="dropdown-item" href="invoice.php"><i class="bi bi-eye"></i></a>
                                                ...
                                                <tr>
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            ...
                                                            <div>
                                                                <a href="invoice.php" class="fs-14 fw-semibold">#INV-0001235</a>
                                                ...
                                                <tr>
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            ...
                                                            <div>
                                                                <a href="invoice.php" class="fs-14 fw-semibold">#INV-0001236</a>
                                                ...
                                                <tr>
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            ...
                                                            <div>
                                                                <a href="invoice.php" class="fs-14 fw-semibold">#INV-0001237</a>
                                                ...
                                                <tr>
                                                    <td> 
                                                        <div class="d-flex gap-2 flex-wrap">
                                                            ...
                                                            <div>
                                                                <a href="invoice.php" class="fs-14 fw-semibold">#INV-0001238</a>
