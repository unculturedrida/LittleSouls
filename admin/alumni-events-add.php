                ...
                <div class="inner-contents">
                    <div class="row">
                        <div class="col-xxl-4">
                            ...
                            <a href="admin-add.php"><button class="btn btn-primary">Add Events</button></a></a>
						</div>
                            </div>
						...
						<div class="card-header py-3">
                            <a href="alumni-events.php"><button class="btn btn-primary">Events List</button></a></a>
						</div>
                        <div class="card-body">
                            <form method="POST" action="alumni-events-add-script.php" enctype="multipart/form-data">
