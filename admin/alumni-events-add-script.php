...
if(isset($_REQUEST['BtnSubmit']))
{
    ...
    $MySqlCommand = "SELECT MAX(id) FROM events";
    ...
    $LastModified = date("l jS F Y h:i:s A");
     $Query = "INSERT INTO events(id, reference, newstitle, newsdesc, ".
...
?>
   <script>
       ...
       window.location.href='alumni-events.php?success';
   </script>
<?php
   } else {
?>
   <script>
       ...
       window.location.href='alumni-events-add.php?error';
   </script>
<?php
   }
}
