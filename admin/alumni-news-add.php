                ...
                <div class="inner-contents">
                    <div class="row">
                        <div class="col-xxl-4">
                            ...
                            <a href="admin-add.php"><button class="btn btn-primary">Add News</button></a></a>
						</div>
                            </div>
						...
						<div class="card-header py-3">
                            <a href="alumni-news.php"><button class="btn btn-primary">News List</button></a></a>
						</div>
                        <div class="card-body">
                            <form method="POST" action="alumni-news-add-script.php" enctype="multipart/form-data">
                                <div class="form-floating mb-3">
                                    <label for="title">News Title</label>
                                    <input class="form-control" id="title" type="text" placeholder="Enter News Title" name="TxtTitle"/>
                                </div>
                                <div class="form-floating mb-3">
                                    <label for="details">News Details</label>
                                    <input class="form-control" id="details" type="text" placeholder="Enter News Details" name="TxtNewsDetails"/>
                                </div>
                                <div class="form-floating mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input class="form-control" id="link" type="text" placeholder="Enter News Link" name="TxtLink"/>
                                </div>
                                <div class="form-floating mb-3">
                                ...
                                <div class="mt-4 mb-0">
                                    <div class="d-grid">
                                    <input class="btn btn-primary btn-block" type="submit" value="Add News" name="BtnSubmit">
                                </div>
                            </form>
                        </div>	
					      </div>
