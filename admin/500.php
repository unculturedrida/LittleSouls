                ...
                <div class="d-flex align-items-center justify-content-center vh-100 bg-white">
                    <div class="card rounded-0 border-0 p-5 m-0 w-100">
                        ...
                        <div class="card-header border-0 p-0">
                            <h1 class="fs-150 lh-150 text-danger text-shadow-404">500</h1>
                            <h2>Unknown Error!</h2>
                            <p class="text-dark mt-4 mb-5">Sorry! The error is unknown.</p>
                        </div>

                        <div class="card-body p-0">
                            <a href="index.html" class="btn btn-sm btn-primary  text-white rounded-2 lh-34 ff-heading fw-bold shadow">Back to Home</a>
                        </div>
                    </div>
                </div>
            </div>
