...
if(isset($_REQUEST['BtnSubmit']))
{
    ...
    $MySqlCommand = "SELECT MAX(id) FROM news";
    ...
    $LastModified = date("l jS F Y h:i:s A");
     $Query = "INSERT INTO news (id, reference, newstitle, newsdesc, ".
...
?>
   <script>
       ...
       window.location.href='alumni-news.php?success';
   </script>
<?php
   } else {
?>
   <script>
       alert('Exception Found While Adding News');
       window.location.href='alumni-news-add.php?error';
   </script>
<?php
   }
}
