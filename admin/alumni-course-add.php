                ...
                <div class="inner-contents">
                    <div class="row">
                        <div class="col-xxl-4">
                            ...
                            <a href="alumni-course-add.php"><button class="btn btn-primary">Add Course</button></a></a>
						</div>
                            </div>
						...
						<div class="card-header py-3">
                            <a href="alumni-courses.php"><button class="btn btn-primary">Courses List</button></a></a>
						</div>
                        <div class="card-body">
                            <form method="POST" action="alumni-course-add-script.php" enctype="multipart/form-data">
                                <div class="form-floating mb-3">
                                    <label for="title">Course Title</label>
                                    <input class="form-control" id="title" type="text" placeholder="Enter Event Title" name="TxtTitle"/>
                                </div>
                                <div class="form-floating mb-3">
                                    <label for="details">Course Details</label>
                                    <input class="form-control" id="details" type="text" placeholder="Enter Event Details" name="TxtNewsDetails"/>
                                </div>
                                <div class="form-floating mb-3">
                                    <label for="postby">Post By</label>
                                    <input class="form-control" id="postby" type="text" placeholder="Enter Post By" name="TxtPostBy"/>
                                </div>
                                <div class="form-floating mb-3">
                                    <label for="link">Course Link</label>
                                    <input class="form-control" id="link" type="text" placeholder="Enter Event Link" name="TxtLink"/>
                                </div>
                                <div class="form-floating mb-3">
                                ...
                                <div class="mt-4 mb-0">
                                    <div class="d-grid">
                                    <input class="btn btn-primary btn-block" type="submit" value="Add Event" name="BtnSubmit">
                                </div>
                            </form>
                        </div>	
					</div>
