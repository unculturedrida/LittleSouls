...
<head>
        ...
        <title>Contact || Little Souls</title>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-12">
                                ...
                                <div class="contact-text">
                                    <p><span class="c-icon"><i class="zmdi zmdi-phone"></i></span><span class="c-text"><?php echo constant("Phone") ?></span></p>
                                    <p><span class="c-icon"><i class="zmdi zmdi-email"></i></span><span class="c-text"><?php echo constant("Email") ?></span></p>
                                    <p><span class="c-icon"><i class="zmdi zmdi-pin"></i></span><span class="c-text"><?php echo constant("Address") ?></span></p>
                                </div>
                                <h4 class="contact-title">social media</h4>
                                <div class="link-social">
                                <a href="<?php echo constant("facebook") ?>"><i class="zmdi zmdi-facebook"></i></a>
                                        <a href="<?php echo constant("whataspp") ?>"><i class="zmdi zmdi-whatsapp"></i></a>
                                        <a href="<?php echo constant("insta") ?>"><i class="zmdi zmdi-instagram"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-12">
                                ...
                                <form  action="#" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" id="fullname" name="TxtName" autofocus placeholder=" Full Name">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="email" id="email" name="TxtEmail" placeholder="Email">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" id="subject" name="TxtSubject" placeholder="Subject">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" id="phone" name="TxtContact" placeholder="Phone no.">
                                        </div>
                                        <div class="col-md-12">
                                            <textarea type="text" id="message" name="TxtMessage" cols="30" rows="10" placeholder="Message"></textarea>
                                            <button type="submit" id="signup" name="BtnSubmit" class="button-default">SUBMIT</button>
                                        </div>
                                    </div>
                                </form>
