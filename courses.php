...
<head>
        ...
        <title>Courses || Little Souls</title>
                            ...
                            <div class="col-md-12">
                                <div class="section-title-wrapper">
                                    <div class="section-title">
                                        <h3>OUR DIRECTRESS</h3>
                                        <p><?php echo constant("abtl4");?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="single-teacher-item">
                                    ...
                                    <div class="single-teacher-text">
                                        <h3><a href="#"><?php echo constant("Directress");?></a></h3>
                                        <h4>Teacher</h4>
...
<!-- Mirrored from htmldemo.hasthemes.com/educat-preview/educat/courses by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Nov 2023 12:21:39 GMT -->
</html>